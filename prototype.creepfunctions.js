    ...
    */
    ...
    summonHauler: function(targroom, haulerHome)
    {
      console.log("h hauler");
        ...
        console.log(Game.time - homeflag.memory.flagstruct.haulerOUT);
        
        
        if(Game.time - homeflag.memory.flagstruct.haulerOUT > 150 && haulersFREE.length != 0)
